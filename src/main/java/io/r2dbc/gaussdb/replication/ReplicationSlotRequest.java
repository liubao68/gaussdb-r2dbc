...
public abstract class ReplicationSlotRequest {
    ...
    public interface WithTemporary {
         ...
         *
         * <p>This feature is only supported by GaussDB versions &gt;= 10.</p>
         *
    ...
    public interface WithOutputPlugin {
         ...
         *
         * <p>Package gaussdb-contrib provides sample output plugin <b>test_decoding</b> that can be use for test logical replication api.
         *
