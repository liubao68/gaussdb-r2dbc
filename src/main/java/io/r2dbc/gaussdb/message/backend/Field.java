...
import static io.r2dbc.gaussdb.message.backend.BackendMessageUtils.readCStringUTF8;
...
public final class Field {
    ...
    public enum FieldType {
        ...
        /**
         * Severity: the field contents are {@code ERROR}, {@code FATAL}, or {@code PANIC} (in an error message), or {@code WARNING}, {@code NOTICE}, {@code DEBUG}, {@code INFO}, or {@code LOG} (in
         * a notice message). This is identical to the {@code S} field except that the contents are never localized. This is present only in messages generated by GaussDB versions 9.6 and later.
         */
