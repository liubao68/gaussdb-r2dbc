...
import io.r2dbc.gaussdb.message.backend.CopyData;
...
final class GaussDBReplicationStream implements ReplicationStream {
    ...
    private void sendStatusUpdate() {
        ...
        io.r2dbc.gaussdb.message.frontend.CopyData copyData = new io.r2dbc.gaussdb.message.frontend.CopyData(byteBuf);
