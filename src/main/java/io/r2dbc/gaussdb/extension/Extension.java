 ...
 * <p>
 * Specifically, a custom extension can be registered by supplying its fully qualified class name in a file named {@code io.r2dbc.gaussdb.extension.Extension} within the
