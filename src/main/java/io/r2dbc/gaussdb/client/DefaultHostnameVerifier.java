...
public enum DefaultHostnameVerifier implements HostnameVerifier {
    ...
    static Comparator<String> HOSTNAME_PATTERN_COMPARATOR = new Comparator<String>() {
        ...
        public int compare(String o1, String o2) {
            // The more the dots the better: a.b.c.gaussdb.org is more specific than gaussdb.org
            ...
            // The less the stars the better: gaussdb.org is more specific than *.*.gaussdb.org
            ...
            // The longer the better: gaussdb.org is more specific than sql.org
            int l1 = o1.length();
            int l2 = o2.length();
            if (l1 != l2) {
                return l1 > l2 ? 1 : -1;
